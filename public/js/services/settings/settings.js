...
.value('$fileSettings', {
  ...
  "all-proxy": {
    val: '',
    desc: 'Use this proxy server for all   protocols. To erase previously defined proxy, use "". You can override this setting and specify a proxy server for a particular protocol using server-proxy, https-proxy and ftp-proxy options. This affects all URIs. The format of PROXY is [server://][USER:PASSWORD@]HOST[:PORT].'
  },
  ...
  "ftp-proxy": {
    val: '',
    desc: 'Use this proxy server for FTP. To erase previously defined proxy, use "". See also --all-proxy option. This affects all URIs. The format of PROXY is [server://][USER:PASSWORD@]HOST[:PORT].'
  },
  ...
  "http-proxy": {
    val: '',
    desc: 'Use this proxy server for HTTP. To erase previously defined proxy, use "". See also --all-proxy option. This affects all URIs. The format of PROXY is [server://][USER:PASSWORD@]HOST[:PORT].'
  },

  "http-proxy-passwd": {
    val: '',
    desc: "Set password for --server-proxy option."
  },

  "http-proxy-user": {
    val: '',
    desc: "Set user for --server-proxy option."
  },
  ...
  "parameterized-uri": {
    desc: "Enable parameterized URI support. You can specify set of parts: server://{sv1,sv2,sv3}/foo.iso. Also you can specify numeric sequences with step counter: server://host/image[000-100:2].img. A step counter can be omitted. If all URIs do not point to the same file, such as the second example above, -Z option is required. Default: false",
    val: false,
    options: ["true", "false"],
  },
